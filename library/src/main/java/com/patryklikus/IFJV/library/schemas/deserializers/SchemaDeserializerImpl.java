...
public class SchemaDeserializerImpl implements SchemaDeserializer, JsonDeserializer<JsonSchema> {
    private static final Logger LOG = LoggerFactory.getLogger(SchemaDeserializerImpl.class);
    private final Gson gson;
    private final Yaml yaml;

    public SchemaDeserializerImpl() {
